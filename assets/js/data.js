...
const RouteList = {
    ...
    'ISL': new Route('ISL', ETA_API.MTR_OPEN, '港島綫|Island Line', '007dc5', false, false, ["CHW", "KET"], ["KET", "HKU", "SYP", "SHW", "CEN", "ADM", "WAC", "CAB", "TIH", "FOT", "NOP", "QUB", "SWH", "SKW", "HFC", "CHW"]),
    'KTL': new Route('KTL', ETA_API.MTR_OPEN, '觀塘綫|Kwun Tong Line', '00AB4E', false, false, ["TIK", "WHA"], ["WHA", "HOM", "YMT", "MOK", "PRE", "SKM", "KOT", "LOF", "WTS", "DIH", "CHH", "KOB", "NTK", "KWT", "LAT", "YAT", "TIK"]),
